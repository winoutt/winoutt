<template lang="pug">
  ...
  p
  | The source code, logos, words, designs, videos, samples, layout, graphics, photos, images, information, materials, documents, data, databases, and all other information and intellectual property accessible on or through the Oceanpace website (&nbsp;
  a(href="https://oceanpace.io/") https://www.oceanpace.io/&nbsp;
  ...
  p
  | By using Oceanpace and our website (&nbsp;
  a(href="https://oceanpace.io/") https://www.oceanpace.io/&nbsp;
  ...
  h6.font-weight-bold 6.1. By Using Oceanpace Website, Services and App You Understand That
  ol(type="a")
  ...
  li By using and accessing Oceanpace (website and app) you agree that any information you provide will always be correct, accurate, and according to law.
  ...
  li When using Oceanpace (website and app) it is prohibited to engage in any activity or business which may disrupt or interfere with our app, website content, our services, and our business.
  ...
  ol(type="a")
  li Use defamatory, threatening, illegal, invasive, deceptive, fraudulent, degrading, racist, demeaning, or any sort of inappropriate behavior on Oceanpace.
  li Break or infringe any copyright, trademark, or any other intellectual property law in any way or manner that may cause harm now or in future to Oceanpace and our business.
  ...
  p Except as stated or otherwise provided, our app (Oceanpace), services related to the app, content on this website are provided without warranty or guarantee of any kind whether expressed or implied. We at Oceanpace (
  a(href="https://oceanpace.io/") https://www.oceanpace.io/
